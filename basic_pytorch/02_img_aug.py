...
# ✅ Set your Kaggle API credentials (from kaggle.json)
os.environ["KAGGLE_USERNAME"] = "user"
os.environ["KAGGLE_KEY"] = "xxxx"

# ✅ make kagglehub cache live in the current directory
os.environ["KAGGLEHUB_CACHE"] = os.path.abspath("./")

# Download latest version (entire dataset)
dataset_dir = kagglehub.dataset_download("andrewmvd/animal-faces")

print("Dataset cached at:", dataset_dir)
print("Cache root is:", os.environ["KAGGLEHUB_CACHE"])
...
DATASET_PATH = dataset_dir  # Path สำหรับ Animal Faces dataset
